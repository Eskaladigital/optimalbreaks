...
export default function Footer({ dict, lang = 'en' }: FooterProps) {
  return (
    <footer className="border-t-4 border-[var(--ink)]">
      {/* Legal links row */}
        <div className="flex flex-wrap justify-center gap-2 px-4 py-4 border-b-2 border-dashed border-[var(--ink)]/10">
      ...
      {/* Main footer */}
      <div className="flex flex-col sm:flex-row justify-between items-center px-4 sm:px-6 py-6 sm:py-5 gap-3 sm:gap-2">
        <div
