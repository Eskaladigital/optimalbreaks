    ...
    <div className="lined min-h-screen flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-[420px]">
        ...
        <button
          ...
          className="w-full py-3 px-4 border-[3px] border-[var(--ink)] bg-white hover:bg-[var(--yellow)] transition-all flex items-center justify-center gap-3 mb-4"
          style={{ fontFamily: "'Courier Prime', monospace", fontWeight: 700, fontSize: '13px', letterSpacing: '1px' }}
        >
        ...
        <div className="flex items-center gap-3 my-5">
          ...
          <span style={{ fontFamily: "'Courier Prime', monospace", fontSize: '10px', color: 'var(--dim)', letterSpacing: '2px' }}>
            {es ? 'O CON EMAIL' : 'OR WITH EMAIL'}
          </span>
          <div className="flex-1 h-[2px] bg-[var(--ink)]/10" />
        </div>
